            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name_ruby" class="col-md-4 col-form-label text-md-right">{{ __('フリガナ') }}</label>

                            <div class="col-md-6">
                                <input id="name_ruby" type="text" class="form-control @error('name_ruby') is-invalid @enderror" name="name_ruby" value="{{ old('name_ruby') }}" required autocomplete="name_ruby" autofocus>
